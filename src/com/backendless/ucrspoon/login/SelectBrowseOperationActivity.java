    ...
    else if( property.equals( "Dish" ) )
    {
    	Dish.findAsync( query, new DefaultCallback<BackendlessCollection<Dish>>( SelectBrowseOperationActivity.this )
    		...
    		public void handleResponse( BackendlessCollection<Dish> response )
    		{
    			...
    			Dish secondRestaurant = response.getCurrentPage().get( 1 );
    			...
    			RView_1.setText( "Dish: " +firstRestaurant.getName().toString()+"\n"+
    							 "Restaurant:TacoTaco");
    			
    			
    			RView_3.setText( "Dish: " +secondRestaurant.getName().toString()+"\n"+
						 		 "Restaurant:McRonal's");
